...
#define TEXT_RETRIES "retries"
#define TEXT_VERIFY_SSL "verifySsl"
#define TEXT_USE_PROXIES "useProxies"
#define TEXT_LAST_DIRECTORY "lastDirectory"
#define TEXT_PROXIES_FILE "proxiesFilePath"
